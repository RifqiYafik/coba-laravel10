            ...
            <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group my-2">
                    ...
                    <input type="number" name="id_siswa" class="form-control @error('id_siswa') is-invalid @enderror">
                    @error('id_siswa')
                    <span class="invalid-feedback" role="alert">
                      <strong>{{ $message }}</strong>
                    </span>
                  ...
                  <div class="form-group my-2 row">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="tmpt_lahir" class="form-control @error('tmpt_lahir') is-invalid @enderror">
                        @error('tmpt_lahir')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                  ...
                  <div class="form-group my-2">
                    ...
                    @foreach (App\Models\Asal_Sekolah::all() as $asal_sekolah)
                        <option value="{{ $asal_sekolah->id }}">{{ $asal_sekolah->nama_sekolah }}</option>
                    @endforeach
                    </select>
                    @error('asal_sekolah')
                    <span class="invalid-feedback" role="alert">
                  ...
                  <div class="form-group my-2">
                    ...
                    @foreach (App\Models\Penempatan::all() as $penempatan)
                        <option value="{{ $penempatan->id }}">{{ $penempatan->name }}</option>
                    @endforeach
                    </select>
                    @error('penempatan')
                    <span class="invalid-feedback" role="alert">
