                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group my-2">
                            ...
                            <select name="asal_sekolah" class="form-control">
                                ...
                                @foreach($asal_sekolahs as $asal_sekolah)
                                    <option value="{{ $asal_sekolah->id }}" {{ old('asal_sekolah', $siswa->asal_sekolah) == $asal_sekolah->id ? 'selected' : '' }}>{{ $asal_sekolah->nama_sekolah }}</option>
                                @endforeach
                            </select>
                            @error('asal_sekolah')
                                <span class="text-danger" role="alert">
                        ...
                        <div class="form-group my-2">
                            ...
                            <select name="penempatan" class="form-control">
                                ...
                                @foreach($penempatans as $penempatan)
                                    <option value="{{ $penempatan->id }}" {{ old('penempatan', $siswa->penempatan) == $penempatan->id ? 'selected' : '' }}>{{ $penempatan->name }}</option>
                                @endforeach
                            </select>
                            @error('penempatan')
                                <span class="text-danger" role="alert">
